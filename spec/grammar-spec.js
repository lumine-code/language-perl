describe("Perl grammar", function () {
  ...
  beforeEach(function () {
    ...
    runs(() => (grammar = lumine.grammars.grammarForScopeName("source.perl")));
  });
  ...
  describe("when a regexp compile tokenizes", function () {
    it("works with all bracket/seperator variations", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.compile.simple-delimiter.perl"],
      });
      ...
      expect(tokens[5]).toEqual({
        value: ";",
        scopes: ["source.perl", "punctuation.terminator.semicolon.perl"],
      });
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.compile.nested_parens.perl"],
      });
      expect(tokens[3]).toEqual({
        value: ")",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.compile.nested_braces.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "}",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.compile.nested_brackets.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "]",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.compile.nested_ltgt.perl"],
      });
      expect(tokens[3]).toEqual({
        value: ">",
        scopes: [
    ...
    it("does not treat ( in a class as a group", function () {
      ...
      expect(tokens[5]).toEqual({
        value: "[",
        scopes: ["source.perl", "string.regexp.find-m.simple-delimiter.perl"],
      });
    ...
    it("does not treat 'm'(hashkey) as a regex match begin", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "{",
        scopes: ["source.perl", "punctuation.section.brace.curly.bracket.begin.perl"],
      });
      expect(tokens[4]).toEqual({
        value: "m",
        scopes: ["source.perl", "constant.other.bareword.perl"],
      });
      expect(tokens[5]).toEqual({
        value: "}",
        scopes: ["source.perl", "punctuation.section.brace.curly.bracket.end.perl"],
      });
    });
  ...
  describe("when a regexp find tokenizes", function () {
    it("works with all bracket/seperator variations", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "/",
        scopes: ["source.perl", "string.regexp.find.perl", "punctuation.definition.string.perl"],
      });
      expect(tokens[4]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.find.perl"],
      });
      expect(tokens[5]).toEqual({
        value: "/",
        scopes: ["source.perl", "string.regexp.find.perl", "punctuation.definition.string.perl"],
      ...
      expect(tokens[5]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.find-m.nested_parens.perl"],
      });
      expect(tokens[6]).toEqual({
        value: ")",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.find-m.nested_braces.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "}",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.find-m.nested_brackets.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "]",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.find-m.nested_ltgt.perl"],
      });
      expect(tokens[6]).toEqual({
        value: ">",
        scopes: [
...
/asd/;`);
      expect(lines[0][3]).toEqual({
        value: "=~",
        scopes: ["source.perl", "keyword.operator.comparison.perl"],
      });
...
/x`);
    ...
    it("works in a if", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "(",
        scopes: ["source.perl", "punctuation.section.parenthesis.round.bracket.begin.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "/",
        scopes: ["source.perl", "string.regexp.find.perl", "punctuation.definition.string.perl"],
      ...
      expect(tokens[7]).toEqual({
        value: ")",
        scopes: ["source.perl", "punctuation.section.parenthesis.round.bracket.end.perl"],
      });
      ...
      expect(tokens[4]).toEqual({
        value: "_",
        scopes: ["source.perl", "variable.other.predefined.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "&&",
        scopes: ["source.perl", "keyword.operator.logical.c-style.perl"],
      });
      expect(tokens[8]).toEqual({
        value: "/",
        scopes: ["source.perl", "string.regexp.find.perl", "punctuation.definition.string.perl"],
  ...
  describe("when a regexp replace tokenizes", function () {
    it("works with all bracket/seperator variations", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.replaceXXX.simple_delimiter.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "/",
        scopes: [
      ...
      expect(tokens[4]).toEqual({
        value: "test",
        scopes: ["source.perl", "string.regexp.replaceXXX.format.simple_delimiter.perl"],
      });
      expect(tokens[5]).toEqual({
        value: "/",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.nested_parens.perl"],
      });
      expect(tokens[3]).toEqual({
        value: ")",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "test",
        scopes: ["source.perl", "string.regexp.format.nested_parens.perl"],
      });
      expect(tokens[6]).toEqual({
        value: ")",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.nested_braces.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "}",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "test",
        scopes: ["source.perl", "string.regexp.format.nested_braces.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "}",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.nested_brackets.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "]",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "test",
        scopes: ["source.perl", "string.regexp.format.nested_brackets.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "]",
        scopes: [
      ...
      expect(tokens[2]).toEqual({
        value: "text",
        scopes: ["source.perl", "string.regexp.nested_ltgt.perl"],
      });
      expect(tokens[3]).toEqual({
        value: ">",
        scopes: [
      ...
      expect(tokens[5]).toEqual({
        value: "test",
        scopes: ["source.perl", "string.regexp.format.nested_ltgt.perl"],
      });
      expect(tokens[6]).toEqual({
        value: ">",
        scopes: [
...
/chr($1)/gxe;`);
  ...
  describe("tokenizes constant variables", function () {
    it("highlights constants", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "__FILE__",
        scopes: ["source.perl", "constant.language.perl"],
      });
  ...
  describe("when an __END__ constant is used", () =>
    it("highlights subsequent lines as comments", function () {
...
`);
      expect(lines[2][0]).toEqual({
        value: '"String";',
        scopes: ["source.perl", "comment.block.documentation.perl"],
      });
    }));

  describe("tokenizes compile phase keywords", () =>
    it("does highlight all compile phase keywords", function () {
      let { tokens } = grammar.tokenizeLine("BEGIN");
      expect(tokens[0]).toEqual({
        value: "BEGIN",
        scopes: ["source.perl", "meta.function.perl", "entity.name.function.perl"],
      });
  ...
  describe("tokenizes method calls", () =>
    it("does not highlight if called like a method", function () {
      let { tokens } = grammar.tokenizeLine("$test->q;");
      expect(tokens[2]).toEqual({
        value: "->",
        scopes: ["source.perl", "punctuation.separator.arrow.perl"],
      });
      ...
      expect(tokens[1]).toEqual({
        value: "test",
        scopes: ["source.perl", "variable.other.readwrite.global.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "->",
        scopes: ["source.perl", "punctuation.separator.arrow.perl"],
  ...
  describe("when a function call tokenizes", () =>
    it("does not highlight calls which looks like a regexp", function () {
      ...
      expect(tokens[4]).toEqual({
        value: ",",
        scopes: ["source.perl", "punctuation.separator.comma.perl"],
      });
      ...
      expect(tokens[7]).toEqual({
        value: "t_storage",
        scopes: ["source.perl", "string.quoted.double.perl"],
      });
      expect(tokens[8]).toEqual({
        value: '\\"',
  ...
  describe("tokenizes single quoting", function () {
    it("does not escape characters in single-quote strings", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "Test this\\nsimple one",
        scopes: ["source.perl", "string.quoted.single.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "'",
        scopes: [
...
last
      ...
      expect(lines[1][0]).toEqual({
        value: "This is my first line\\n",
        scopes: ["source.perl", "string.quoted.other.q-paren.perl"],
      });
      expect(lines[2][0]).toEqual({
        value: "and this the second one\\x00",
        scopes: ["source.perl", "string.quoted.other.q-paren.perl"],
      });
      expect(lines[3][0]).toEqual({
        value: "last",
...
~;`);
  ...
  describe("tokenizes double quoting", () =>
    it("does escape characters in double-quote strings", function () {
      let { tokens } = grammar.tokenizeLine('"Test\\tthis\\nsimple one";');
      expect(tokens[0]).toEqual({
        value: '"',
        scopes: [
      ...
      expect(tokens[1]).toEqual({
        value: "Test",
        scopes: ["source.perl", "string.quoted.other.qq-paren.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "\\t",
        scopes: [
      ...
      expect(tokens[1]).toEqual({
        value: "Test",
        scopes: ["source.perl", "string.quoted.other.qq.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "\\t",
...
`);
      expect(lines[0][0]).toEqual({
        value: "sub",
        scopes: ["source.perl", "meta.function.perl", "storage.type.function.sub.perl"],
      });
      ...
      expect(lines[1][1]).toEqual({
        value: "print",
        scopes: ["source.perl", "support.function.perl"],
      });
      expect(lines[1][3]).toEqual({
        value: '"',
        scopes: [
...
`);
      expect(lines[0][0]).toEqual({
        value: "my",
        scopes: ["source.perl", "storage.modifier.perl"],
      });
      expect(lines[0][2]).toEqual({
        value: "$",
        scopes: [
      ...
      expect(lines[0][5]).toEqual({
        value: "=",
        scopes: ["source.perl", "keyword.operator.assignement.perl"],
      });
...
`);
      ...
      expect(lines[0][9]).toEqual({
        value: "a",
        scopes: ["source.perl", "constant.other.key.perl"],
      });
      expect(lines[0][11]).toEqual({
        value: "=>",
        scopes: ["source.perl", "punctuation.separator.key-value.perl"],
      });
...
.`);
      expect(lines[0][0]).toEqual({
        value: "format",
        scopes: ["source.perl", "meta.format.perl", "support.function.perl"],
      });
      expect(lines[0][2]).toEqual({
        value: "STDOUT_TOP",
        scopes: ["source.perl", "meta.format.perl", "entity.name.function.format.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "Passwd File",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[2][0]).toEqual({
        value: "Name                Login    Office   Uid   Gid Home",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[3][0]).toEqual({
        value: "------------------------------------------------------------------",
...
.`);
      ...
      expect(lines[13][0]).toEqual({
        value: "From: @<<<<<<<<<<<<<<<<<<<<<<<<<<<<< ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[15][0]).toEqual({
        value: "Assigned to: @<<<<<<<<<<<<<<<<<<<<<< ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[17][0]).toEqual({
        value: "~                                    ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[19][0]).toEqual({
        value: "~                                    ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[21][0]).toEqual({
        value: "~                                    ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[23][0]).toEqual({
        value: "~                                    ^<<<<<<<<<<<<<<<<<<<<<<<<<<<<",
        scopes: ["source.perl", "meta.format.perl"],
      });
      expect(lines[25][0]).toEqual({
        value: "~                                    ^<<<<<<<<<<<<<<<<<<<<<<<...",
        scopes: ["source.perl", "meta.format.perl"],
      });
...
`);
  ...
  describe("when encountering `v` followed by dot-delimited digits", () =>
    it("tokenises it as a version literal", function () {
      const lines = grammar.tokenizeLines(`\
use v5.14
use v5.24.1\
`);
      expect(lines[0][0]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.preprocessor.pragma.perl",
          "keyword.control.directive.pragma.use.perl",
        ],
      });
      expect(lines[0][2]).toEqual({
        value: "v5.14",
        scopes: [
          "source.perl",
          "meta.preprocessor.pragma.perl",
          "constant.other.version.literal.perl",
        ],
      });
      expect(lines[1][0]).toEqual({
        value: "use",
  ...
  describe("when an operator tokenizes", function () {
    it("highlights assignement operators", function () {
      ...
      expect(tokens[4]).toEqual({
        value: "||=",
        scopes: ["source.perl", "keyword.operator.assignement.conditional.perl"],
      });
      expect(tokens[6]).toEqual({
        value: "//=",
        scopes: ["source.perl", "keyword.operator.assignement.conditional.perl"],
      ...
      expect(tokens[8]).toEqual({
        value: "+=",
        scopes: ["source.perl", "keyword.operator.assignement.compound.perl"],
      });
      expect(tokens[10]).toEqual({
        value: "-=",
        scopes: ["source.perl", "keyword.operator.assignement.compound.perl"],
      ...
      expect(tokens[20]).toEqual({
        value: "&=",
        scopes: ["source.perl", "keyword.operator.assignement.compound.bitwise.perl"],
      });
      ...
      expect(tokens[26]).toEqual({
        value: "&.=",
        scopes: ["source.perl", "keyword.operator.assignement.compound.stringwise.perl"],
      });
    ...
    it("highlights arithmetic operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "+",
        scopes: ["source.perl", "keyword.operator.arithmetic.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "-",
        scopes: ["source.perl", "keyword.operator.arithmetic.perl"],
    ...
    it("highlights increment/decrement operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "++",
        scopes: ["source.perl", "keyword.operator.increment.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "--",
        scopes: ["source.perl", "keyword.operator.decrement.perl"],
      });
    });
    ...
    it("highlights bitwise operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "&",
        scopes: ["source.perl", "keyword.operator.bitwise.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "|",
        scopes: ["source.perl", "keyword.operator.bitwise.perl"],
    ...
    it("highlights stringwise operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "&.",
        scopes: ["source.perl", "keyword.operator.stringwise.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "|.",
        scopes: ["source.perl", "keyword.operator.stringwise.perl"],
    ...
    it("highlights stringwise comparison operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "eq",
        scopes: ["source.perl", "keyword.operator.comparison.stringwise.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "ne",
        scopes: ["source.perl", "keyword.operator.comparison.stringwise.perl"],
...
`);
      ...
      expect(lines[0][1]).toEqual({
        value: " ... ",
        scopes: ["source.perl", "keyword.operator.ellipsis.placeholder.perl"],
      });
      expect(lines[0][2]).toEqual({
        value: "}",
        scopes: ["source.perl", "punctuation.section.brace.curly.bracket.end.perl"],
      ...
      expect(lines[2][0]).toEqual({
        value: "...",
        scopes: ["source.perl", "keyword.operator.range.perl"],
      });
      expect(lines[2][1]).toEqual({
        value: ";",
        scopes: ["source.perl", "punctuation.terminator.semicolon.perl"],
      ...
      expect(lines[3][0]).toEqual({
        value: "eval",
        scopes: ["source.perl", "keyword.control.perl"],
      });
      expect(lines[3][2]).toEqual({
        value: "{",
        scopes: ["source.perl", "punctuation.section.brace.curly.bracket.begin.perl"],
...
`);
    ...
    it("highlights logical operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "and",
        scopes: ["source.perl", "keyword.operator.logical.perl"],
      });
      expect(tokens[2]).toEqual({
        value: "or",
        scopes: ["source.perl", "keyword.operator.logical.perl"],
    ...
    it("highlights defined-or logical operators", function () {
      ...
      expect(tokens[3]).toEqual({
        value: "//",
        scopes: ["source.perl", "keyword.operator.logical.defined-or.perl"],
      });
    });
    ...
    it("highlights concatenation operators", function () {
      ...
      expect(tokens[3]).toEqual({
        value: ".",
        scopes: ["source.perl", "keyword.operator.concatenation.perl"],
      });
    });
...
`);
      ...
      expect(lines[0][4]).toEqual({
        value: "x",
        scopes: ["source.perl", "keyword.operator.repetition.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "'",
        scopes: [
    ...
    it("highlights readline operators", function () {
      ...
      expect(tokens[0]).toEqual({
        value: "<",
        scopes: ["source.perl", "keyword.operator.readline.perl"],
      });
      expect(tokens[1]).toEqual({
        value: ">",
        scopes: ["source.perl", "keyword.operator.readline.perl"],
...
`);
    ...
    it("highlights double colons", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "::",
        scopes: ["source.perl", "punctuation.separator.colon.perl"],
      });
    });
...
`);
      expect(lines[0][0]).toEqual({
        value: "0",
        scopes: ["source.perl", "constant.numeric.decimal.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "0",
        scopes: ["source.perl", "constant.numeric.decimal.perl"],
      ...
      expect(lines[1][1]).toEqual({
        ...
        scopes: [
          "source.perl",
          "constant.numeric.decimal.perl",
          "punctuation.delimiter.decimal.period.perl",
        ],
      });
      expect(lines[2][0]).toEqual({
        value: ".",
...
`);
      expect(lines[0][0]).toEqual({
        value: "0e",
        scopes: ["source.perl", "constant.numeric.exponential.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "0",
        scopes: ["source.perl", "constant.numeric.exponential.perl"],
      ...
      expect(lines[1][1]).toEqual({
        ...
        scopes: [
          "source.perl",
          "constant.numeric.exponential.perl",
          "punctuation.delimiter.decimal.period.perl",
        ],
      });
      expect(lines[1][2]).toEqual({
...
`);
      expect(lines[0][0]).toEqual({
        value: "0x",
        scopes: ["source.perl", "constant.numeric.hexadecimal.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "0x0e0",
        scopes: ["source.perl", "constant.numeric.hexadecimal.perl"],
...
`);
      expect(lines[0][0]).toEqual({
        value: "0b",
        scopes: ["source.perl", "constant.numeric.binary.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "0b10",
        scopes: ["source.perl", "constant.numeric.binary.perl"],
...
`);
  ...
  describe("numbers with thousand separators", () =>
    it("matches them as a single token", function () {
      const lines = grammar.tokenizeLines(`\
my $n = 12345;
my $n = 12345.67;
my $n = -.02e+23;
...
`);
      ...
      expect(lines[4][7]).toEqual({
        value: "4_294_967_296",
        scopes: ["source.perl", "constant.numeric.decimal.with-thousand-separators.perl"],
      });
      ...
      expect(lines[8][5]).toEqual({
        value: "=",
        scopes: ["source.perl", "keyword.operator.assignement.perl"],
      });
      expect(lines[8][7]).toEqual({
        value: "0b1100_0000",
        scopes: ["source.perl", "constant.numeric.binary.perl"],
      });
  ...
  describe("when a hash variable tokenizes", () =>
    it("does not highlight whitespace beside a key as a constant", function () {
...
`);
      ...
      expect(lines[8][11]).toEqual({
        value: "a",
        scopes: ["source.perl", "variable.other.predefined.perl"],
      });
      expect(lines[8][13]).toEqual({
        value: "<=>",
        scopes: ["source.perl", "keyword.operator.comparison.perl"],
      });
      expect(lines[8][15]).toEqual({
        value: "$",
        scopes: [
          "source.perl",
          "variable.other.predefined.perl",
      ...
      expect(lines[8][16]).toEqual({
        value: "b",
        scopes: ["source.perl", "variable.other.predefined.perl"],
      });
      expect(lines[8][17]).toEqual({
        value: "}",
        scopes: ["source.perl", "punctuation.section.brace.curly.bracket.end.perl"],
      });
      expect(lines[8][19]).toEqual({
        value: "@",
        scopes: [
          "source.perl",
          "variable.other.readwrite.global.perl",
      ...
      expect(lines[8][20]).toEqual({
        value: "m",
        scopes: ["source.perl", "variable.other.readwrite.global.perl"],
      });
      expect(lines[8][21]).toEqual({
        value: ";",
        scopes: ["source.perl", "punctuation.terminator.semicolon.perl"],
      });
    });
    ...
    it("does not highlight numbers separately", function () {
      ...
      expect(tokens[1]).toEqual({
        value: "0",
        scopes: ["source.perl", "variable.other.predefined.program-name.perl"],
      });
      expect(tokens[3]).toEqual({
        value: "%",
        scopes: [
  ...
  describe("when package to tokenizes", () =>
    it("does not highlight semicolon in package name", function () {
      const { tokens } = grammar.tokenizeLine("package Test::ASD; #this is my new class");
      expect(tokens[0]).toEqual({
        value: "package",
        scopes: ["source.perl", "meta.class.perl", "keyword.control.perl"],
      });
      expect(tokens[1]).toEqual({ value: " ", scopes: ["source.perl", "meta.class.perl"] });
      expect(tokens[2]).toEqual({
        value: "Test::ASD",
        scopes: ["source.perl", "meta.class.perl", "entity.name.type.class.perl"],
      });
      expect(tokens[3]).toEqual({
        value: ";",
        scopes: ["source.perl", "punctuation.terminator.semicolon.perl"],
      ...
      expect(tokens[6]).toEqual({
        value: "this is my new class",
        scopes: ["source.perl", "comment.line.number-sign.perl"],
      });
    }));
...
`);
      ...
      expect(tokens[28]).toEqual({
        value: ")",
        scopes: ["source.perl", "punctuation.unmatched.parenthesis.round.bracket.end.perl"],
      });
      ...
      expect(tokens[4]).toEqual({
        value: "[",
        scopes: ["source.perl", "punctuation.section.square.bracket.begin.perl"],
      });
      expect(tokens[5]).toEqual({ value: " a ", scopes: ["source.perl"] });
      expect(tokens[6]).toEqual({
        value: "[",
      ...
      expect(tokens[11]).toEqual({
        value: "]",
        scopes: ["source.perl", "punctuation.section.square.bracket.end.perl"],
      });
      expect(tokens[13]).toEqual({
        value: "1",
        scopes: ["source.perl", "constant.numeric.decimal.perl"],
      ...
      expect(tokens[25]).toEqual({
        value: "]",
        scopes: ["source.perl", "punctuation.unmatched.square.bracket.end.perl"],
      });
    });
...
`);
      ...
      expect(lines[0][1]).toEqual({
        value: ":",
        scopes: ["source.perl", "keyword.operator.ternary.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "(",
        scopes: ["source.perl", "punctuation.section.parenthesis.round.bracket.begin.perl"],
      ...
      expect(lines[6][2]).toEqual({
        value: " Also a comment ))))))))))))))) Nothing specil",
        scopes: ["source.perl", "comment.line.number-sign.perl"],
      });
      expect(lines[6][3]).toEqual({
        value: "",
...
`);
      ...
      expect(lines[0][2]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.preprocessor.pragma.perl",
          "constant.language.pragma.module.perl",
        ],
      });
      expect(lines[0][3]).toEqual({
        value: ";",
      ...
      expect(lines[2][0]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.preprocessor.pragma.perl",
          "keyword.control.directive.pragma.no.perl",
        ],
      });
      expect(lines[2][2]).toEqual({
        value: "autodie",
      ...
      expect(lines[3][2]).toEqual({
        value: "open",
        scopes: ["source.perl", "meta.preprocessor.pragma.perl", "support.function.perl"],
      });
      expect(lines[3][4]).toEqual({
        value: "IN",
        scopes: ["source.perl", "meta.preprocessor.pragma.perl", "constant.other.key.perl"],
      });
      ...
      expect(lines[3][9]).toEqual({
        value: ":crlf",
        scopes: ["source.perl", "meta.preprocessor.pragma.perl", "string.quoted.double.perl"],
      });
      expect(lines[3][10]).toEqual({
        value: '"',
        scopes: [
...
`);
      ...
      expect(lines[0][2]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.preprocessor.pragma.perl",
          "invalid.illegal.syntax.pragma.perl",
        ],
      });
      expect(lines[0][4]).toEqual({
        value: "warnings",
...
`);
      expect(lines[0][0]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.diagnostics.pragma.perl",
          "keyword.control.diagnostics.enable.perl",
        ],
      });
      expect(lines[0][2]).toEqual({
        value: "diagnostics",
      ...
      expect(lines[1][0]).toEqual({
        ...
        scopes: [
          "source.perl",
          "meta.diagnostics.pragma.perl",
          "keyword.control.diagnostics.disable.perl",
        ],
      });
      expect(lines[1][2]).toEqual({
        value: "diagnostics",
...
`);
      expect(lines[0][0]).toEqual({
        value: "=pod",
        scopes: ["source.perl", "comment.block.documentation.perl", "storage.type.class.pod.perl"],
      });
      expect(lines[1][0]).toEqual({
        value: "Bar",
        scopes: ["source.perl", "comment.block.documentation.perl"],
    ...
    it("highlights additional command parameters", function () {
      ...
      expect(tokens[2]).toEqual({
        value: "Heading",
        scopes: ["source.perl", "comment.block.documentation.perl", "variable.other.pod.perl"],
      });
    });
...
`);
      ...
      expect(lines[1][1]).toEqual({
        ...
        scopes: [
          ...
          "entity.name.type.instance.pod.perl",
        ],
      });
      expect(lines[1][2]).toEqual({
        value: "perlpod(1)",
        scopes: [
          ...
          "comment.block.documentation.perl",
          "entity.name.type.instance.pod.perl",
          "markup.underline.link.hyperlink.pod.perl",
        ],
      });
      expect(lines[1][3]).toEqual({
        value: ">",
...
`);
      expect(lines[1][0]).toEqual({
        ...
        scopes: [
          "source.perl",
          "comment.block.documentation.perl",
          "meta.embedded.pod.perl",
          "storage.type.class.pod.perl",
        ],
      });
      expect(lines[1][1]).toEqual({
        value: " ",
        scopes: ["source.perl", "comment.block.documentation.perl", "meta.embedded.pod.perl"],
      });
      expect(lines[1][2]).toEqual({
        value: "html",
        scopes: [
